package com.gmail.Haggard_nl.ChestProtect;
...
import com.gmail.Haggard_nl.ChestProtect.Commands.ChestLockCommand;
import com.gmail.Haggard_nl.ChestProtect.Listeners.ChestLockListener;
...
public class ChestProtect extends JavaPlugin {
    ...
    public void onEnable () {
        ...
        //Find Permissions
        if (!setupPermissions() ) {
	        log(String.format("[Kits] - Disabled due to no permission dependency found!", getDescription().getName()));
        ...
        //Find Economy
        if (!setupEconomy() ) {
	        log(String.format("[Kits] - Disabled due to no economy dependency found!", getDescription().getName()));
	        getServer().getPluginManager().disablePlugin(this);
	        return;
	    }
    ...
    private boolean setupEconomy() {
	    if (getServer().getPluginManager().getPlugin("ServerCore") == null) {
	        return false;
	    }
